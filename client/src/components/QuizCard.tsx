    ...
    >
      ...
      <div className="flex justify-center mb-4 sm:mb-6">
        <div className={cn(
          ...
          <span className="text-xs sm:text-sm font-medium">сек</span>
        </div>
      </div>
          ...
          {question.options.map((option, index) => {
            ...
            return (
              <motion.button
                ...
                whileHover={!isAnswerRevealed ? { scale: 1.02, y: -2 } : undefined}
                ...
                className={cn(
                  ...
                  !isAnswerRevealed && "bg-white border-slate-200 sm:hover:border-indigo-300 cursor-pointer",
                  isSelected && !isAnswerRevealed && "border-indigo-500 bg-indigo-50 shadow-md",
                  showCorrect && "bg-emerald-50 border-emerald-400 shadow-lg",
                  showIncorrect && "bg-rose-50 border-rose-400 shadow-lg",
                  isAnswerRevealed && !showCorrect && !showIncorrect && "opacity-60"
                )}
              >
                {/* Answer label */}
                <motion.div 
                  animate={showCorrect ? { scale: [1, 1.1, 1] } : showIncorrect ? { scale: [1, 0.95, 1] } : {}}
